...
Cependant, il reste des problèmes : les choix de complétion ne contiennent que les labels déclarés dans le document courant, alors que l'un des avantages du langage \LaTeX{} est de permettre les références entre entre différents fichiers composant un même projet.
...
D'une part, nous avons modifié notre structure de donnée pour que la clé de la table de hachage qui contient nos données de complétion soit désormais le chemin absolu du répertoire parent du document courant. % Je veux votre approbtion
