...
Elles s'étalent sur l'année scolaire et visent à permettre aux étudiants de développer leur sens du travail en équipe ainsi que leur autonomie.
...
\begin{description}
  ...
  \item[Argument] peut être définit par \LaTeX~ou tiré de l'environnement utilisateur\footnote{non pris en charge car nécessite une complétion dynamique}
\end{description}
